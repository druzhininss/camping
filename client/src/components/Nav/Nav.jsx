...
function Nav() {
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-light" style={{ background: 'linear-gradient(#28292bce, #50525400)', padding: '30px' }}>
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-end">
            {login
              ...
              <>
                ...
                <li className={styleNav.nav_link_style}>
                  <Link style={{ color: '#e0e0e0ea' }} className="nav-link" to='/' onClick={() => dispatch(userLogoutAC())}>Выйти</Link>
                </li>
              </>
              :
              <>
