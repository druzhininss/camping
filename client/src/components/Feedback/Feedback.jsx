  ...
  return (
    <div>
      ...
      <div className={style.feedback}>
        <div className={style.koguvcavis_varazdel}>
          <div className={style.sestim_donials}>
            <div className={style.sectionesag}></div>
            ...
            <div className={style.sagestim_lonials}>
              <div className={style.vemotau_vokusipol}>
                <div className={style.testimonial}>
                  ...
                  <div className={style.gecedanam}>Oleg</div>
                  <div className={style.apogered_gselected}>
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
                    <i className="fas fa-star"></i>
                  ...
                  <p>Почему у всех одинаковые фото.</p>
                </div>
              </div>
            </div>
          </div>
